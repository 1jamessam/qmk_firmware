...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [_COLEMAK] = LAYOUT(
  KC_ESC,   KC_1,   KC_PSLS, KC_PAST, KC_MINS, KC_PLUS,                                KC_MPRV,  KC_MPLY,          KC_MFFD, KC_MUTE, KC_VOLD, KC_VOLU,
  KC_TAB,   KC_Q,   KC_W,    KC_F,    KC_P,    KC_B,                                   KC_J,     KC_L,             KC_U,    KC_Y,    KC_SCLN, KC_PGUP,
  KC_BSPC,  KC_A,   KC_R,    KC_S,    KC_T,    KC_G,                                   KC_M,     LT(_SYMBOL,KC_N), KC_E,    KC_I,    KC_O,    KC_QUOT,
  KC_CAPS,  KC_Z,   KC_X,    KC_C,    KC_D,    KC_V,        KC_MINS, QK_REP,           KC_K,     KC_H,             KC_COMM, KC_DOT,  KC_SLSH, KC_PGDN,
                          KC_LALT, KC_LGUI, KC_LGUI, LSFT_T(KC_SPC), LT(_NAVI,KC_ENT), MO(_NUM), KC_RGUI,          KC_RGUI
 ),
 ...
 [_SYMBOL] = LAYOUT(
  ...
  KC_PIPE, KC_TILD, KC_LCBR, KC_RCBR, KC_COLN, KC_PERC, XXXXXXX, XXXXXXX, XXXXXXX, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE,
